...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.login = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var user, valid, accessToken, refreshToken;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            if (!valid)
                                throw new Error('Invalid credentials');
                            accessToken = this.jwt.sign({ id: user.id, email: user.email, role: user.role }, { secret: process.env.JWT_SECRET, expiresIn: '1h' });
                            refreshToken = this.jwt.sign({ id: user.id }, { secret: process.env.JWT_REFRESH_SECRET, expiresIn: '7d' });
