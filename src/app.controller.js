...
var AppController = function () {
    ...
    var AppController = _classThis = /** @class */ (function () {
        ...
        AppController_1.prototype.getProtected = function () {
            return {
    ...
    (function () {
        ...
        _getProtected_decorators = [(0, common_1.Get)('protected'), (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'))];
        ...
        __esDecorate(_classThis, null, _getProtected_decorators, { kind: "method", name: "getProtected", static: false, private: false, access: { has: function (obj) { return "getProtected" in obj; }, get: function (obj) { return obj.getProtected; } }, metadata: _metadata }, null, _instanceExtraInitializers);
