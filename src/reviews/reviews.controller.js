...
var ReviewsController = function () {
    ...
    var ReviewsController = _classThis = /** @class */ (function () {
        function ReviewsController_1(reviews) {
            this.reviews = (__runInitializers(this, _instanceExtraInitializers), reviews);
        }
        ReviewsController_1.prototype.create = function (dto) {
            return this.reviews.create(dto);
        };
        ReviewsController_1.prototype.findAll = function () {
